...
def start():
    ...
    button_quit = Button(root,text='QUIT',width=10,font=('bold',16),bg='red',fg='white',command=quit)
    button_quit.place(x=185,y=500)

    #creating a restart button
    button_restart = Button(root,text='RESTART',width=10,font=('bold',16),bg='red',fg='white',command=restart)
    button_restart.place(x=430,y=500)
